...
certora-vat	:;certoraRun --solc ~/.solc-select/artifacts/solc-0.8.13 src/Vat.sol --verify Vat:certora/Vat.spec --rule_sanity $(if $(rule),--rule $(rule),) --multi_assert_check --short_output
